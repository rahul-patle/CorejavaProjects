...
public class VidyarthiTest2 {
	...
	//  System.out.println(students[0].marks);
		...
		}for (Vidyarthi vidyarthi2 : vidyarthi) {
			System.out.println(vidyarthi2);
		}
...
//System.out.println(10<2 & "java".charAt(4)=='a');<== index out of bound
		...
		for(Vidyarthi vid : vidyarthi) //<=== iterating object reference
		{
				...
				if( total > max)
				{
					max=total;//170
					maxStudent=vid;
// take a variable wich store an object			
			}
